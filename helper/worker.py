...
async def screenshot(e):
    ...
    try:
        ...
        await e.client.send_message(
            ...
            buttons=[
                [
                    Button.inline("▫️ GENERATE SAMPLE", data=f"gsmpl{wah}"),
    ...
    try:
        ...
        nn = await e.edit(
            ...
            buttons=[
                ...
                [Button.inline("❌️ CANCEL PROCESS ❌️", data=f"skip{wah}")],
            ],
        )
...
async def sample(e):
    ...
    try:
        ds = await e.client.send_file(
            ...
            buttons=[
                [
                    Button.inline("▫️ SCREENSHOTS", data=f"sshot{wah}"),
                    Button.inline("▪️ COMPRESS", data=f"sencc{wah}"),
                ],
                [Button.inline("🔺 SKIP", data=f"skip{wah}")],
            ],
        )
